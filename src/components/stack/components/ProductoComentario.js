                                ...
                                <ImageBackground source={bgImage} style={styles.containerMain}>
                                    <View style={styles.container}>
                                        ...
                                        <View style={styles.content}>
                                            <Text style={{ top: 7, color: 'white', fontSize: 18 }}>{Notification.description}</Text>
                                        </View>
                                    </View>
                                </ImageBackground>
                            );
                        ...
                        <View style={styles.contentSpinner}>
                            ...
                            <View style={styles.container2}>
                                <View style={styles.buttonContainer}>
                                    <Button danger style={{ marginLeft: 10, marginRight: 10, width: 100 }} onPress={this.toggleModal}>
                                        <Text onPress={this.toggleModal} style={styles.TextStyle} >Cerrar</Text>
                                    </Button>
                                </View>
                                <View style={styles.buttonContainer}>
                                    <Button success style={{ marginLeft: 10, marginRight: 10, width: 100 }} onPress={this.validarCampos}>
