...
setImageFood(foodScore){
  if(foodScore<=10) {
    return imagen = 'https://firebasestorage.googleapis.com/v0/b/tesis-celiacos.appspot.com/o/images%2FImageMedallas%2Fmedalla33.png?alt=media&token=79c0424c-6c6d-483c-b9ce-57615da29e0e'
  }
  if(foodScore>10 && foodScore<=30) {
    return imagen = 'https://firebasestorage.googleapis.com/v0/b/tesis-celiacos.appspot.com/o/images%2FImageMedallas%2Fbronce.PNG?alt=media&token=2a542da3-78b9-4931-b781-16ab8e17bc78'
  }
  if(foodScore>30 && foodScore<=60) {
    return imagen = 'https://firebasestorage.googleapis.com/v0/b/tesis-celiacos.appspot.com/o/images%2FImageMedallas%2Fplata.png?alt=media&token=000bb565-a639-4ec8-a52e-7041cd0712a9'
  }
  if(foodScore>60) {
    return imagen = 'https://firebasestorage.googleapis.com/v0/b/tesis-celiacos.appspot.com/o/images%2FImageMedallas%2Foro.jpg?alt=media&token=5d2b1f6d-3b36-41fe-a567-ca6eeaab18ad'
  }
}
setImageCleaning(foodScore){
  if(foodScore<=10) {
    return imagen = 'https://firebasestorage.googleapis.com/v0/b/tesis-celiacos.appspot.com/o/images%2FImageMedallas%2Fmedalla33.png?alt=media&token=79c0424c-6c6d-483c-b9ce-57615da29e0e'
  }
  if(foodScore>10 && foodScore<=30) {
      ...
      <Container>
          ...
          <Modal style={styles.container} isVisible={this.state.isModalVisible}>
            ...
            <ScrollView 
              ...
              <Accordion dataArray={this.state.dataArray} expanded={0} style={{ bottom:50 }}/>  
              {!this.state.spinner && <Button danger style={{ width:90, }} onPress={this.toggleModal}><Text style={{ fontSize: 20, color:"white", left:4}}>Cerrar</Text></Button>}
            </View>
           </Modal>
