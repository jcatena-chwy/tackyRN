        ...
        navigationOptions: ({ navigation }) => ({
            ...
            headerTitle: (
                <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <Image style={{ width: 100, height: 73, left: 100 }} source={require('./assets/titleImage.png')} />
                </View>
            ),
        ...
        navigationOptions: ({ navigation }) => ({
            headerTitle: (
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <Image style={{ width: 100, height: 73, left: 80 }} source={require('./assets/titleImage.png')} />
                </View>
            ),
            headerBackTitle: '',
            headerStyle: {
        ...
        navigationOptions: ({ navigation }) => ({
            ...
            headerTitle: (
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <Image style={{ width: 100, height: 73, left: 115 }} source={require('./assets/titleImage.png')} />
                </View>
            ),
            headerLeft: <NavigationDrawerStructure navigationProps={navigation} />,
            headerStyle: {
